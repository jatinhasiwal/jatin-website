    ...
    <div className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
      ...
      <nav className="relative z-50 px-6 lg:px-12 py-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <button onClick={() => scrollToSection('about')} className="text-gray-300 hover:text-yellow-400 transition-colors font-medium">
            About
          </button>
          <button onClick={() => scrollToSection('skills')} className="text-gray-300 hover:text-yellow-400 transition-colors font-medium">
            Skills
          </button>
          <button onClick={() => scrollToSection('projects')} className="text-gray-300 hover:text-yellow-400 transition-colors font-medium">
            Projects
          </button>
          <button onClick={() => scrollToSection('contact')} className="text-gray-300 hover:text-yellow-400 transition-colors font-medium">
            Contact
          </button>
          <button
      ...
      {menuOpen && (
        <div className="md:hidden absolute top-20 left-0 right-0 bg-black/95 backdrop-blur-lg z-40 px-6 py-8 space-y-6">
          <button onClick={() => scrollToSection('about')} className="block w-full text-left text-gray-300 hover:text-yellow-400 transition-colors font-medium text-lg">
            About
          </button>
          <button onClick={() => scrollToSection('skills')} className="block w-full text-left text-gray-300 hover:text-yellow-400 transition-colors font-medium text-lg">
            Skills
          </button>
          <button onClick={() => scrollToSection('projects')} className="block w-full text-left text-gray-300 hover:text-yellow-400 transition-colors font-medium text-lg">
            Projects
          </button>
          <button onClick={() => scrollToSection('contact')} className="block w-full text-left text-gray-300 hover:text-yellow-400 transition-colors font-medium text-lg">
            Contact
          </button>
          <button
            onClick={() => scrollToSection('contact')}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pt-20 lg:pt-32 pb-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-400 leading-relaxed">
              A Computer Science graduate passionate about Web development, AI, and building innovative solutions. Currently exploring Web Development and AI opportunities. Quick learner with a strong foundation in Python and full-stack development.
            </p>
          ...
          <div className="relative">
            <div className="relative z-10 aspect-square rounded-2xl overflow-hidden border border-gray-800">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-64 h-64 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full opacity-20 blur-3xl"></div>
              </div>
